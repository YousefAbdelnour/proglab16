 ...
 * @author 2242238
 */
public class Lab16 extends javax.swing.JFrame {

    /**
     * Creates new form Lab16
     */
    public Lab16() {
    ...
    private void initComponents() {
        ...
        libraryLabel.setText("Please enter your Hospital's name: ");

        createLibraryButton.setText("Create!");
        ...
        hospitalName.getAccessibleContext().setAccessibleName("");

        getAccessibleContext().setAccessibleName("libraryLabel");
    ...
    private void createLibraryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createLibraryButtonActionPerformed
        ...
        HospitalController hospitalController = new HospitalController(name);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lab16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
